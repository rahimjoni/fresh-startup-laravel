                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="list-group">
                                    <a href="{{ route('settings.general') }}" class="list-group-item list-group-item-action">General</a>
                                    <a href="{{ route('settings.general') }}" class="list-group-item list-group-item-action">Appearance</a>
                                    <a href="{{ route('settings.general') }}" class="list-group-item list-group-item-action">General</a>
                                    <a href="{{ route('settings.general') }}" class="list-group-item list-group-item-action">General</a>
                                </div>
                            </div>
